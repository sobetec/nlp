...
public class Report {
	...
	public String getOrgnFilePath() {
		return orgnFilePath;
	}
	public void setOrgnFilePath(String orgnFilePath) {
	...
	public String getPropNoun() {
		return propNoun;
	}
	public void setPropNoun(String propNoun) {
		this.propNoun = propNoun;
	}
	public String getDocCaty() {
		return docCaty;
	}
